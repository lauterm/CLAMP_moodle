# [Moodle Liberal Arts Edition v2.3.11-LAE3.1.4]
...
Moodle 2.3.11+LAE3.1.4 consists of the core Moodle 2.3.11 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v2.3.11-LAE3.1.4
    git checkout -b v2.3.11-LAE3.1.4
